  ...
  return (
    <div>
      ...
      <input
        id={id}
        ref={ref}
        className={`w-full border-2 border-gray-700 bg-arcano-bg p-3 text-white transition-colors placeholder:text-white/30 focus:border-arcano-main focus:outline-none ${className}`}
        {...props}
      />
